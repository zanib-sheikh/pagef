...
const Navbar = () => {
  ...
  return (
    <>
    <div className="w-full bg-gray-700 text-black py-2 px-10 flex justify-between  items-center">
  {/* Phone Number (Left Side) */}
  <span className="text-lg font-bold text-gray-200">333-444-5566</span>
  ...
  <div className="relative w-80">
    <input
      type="text"
      placeholder="Search..."
      className="w-full py-1 px-3 bg-gray-300 rounded-full border border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
    />
    <button className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-600">
      ...
      {/* Navbar */}
      <nav className="absolute top-[44px] font-kanit z-20 left-0 w-full bg-transparent">
        <div className="container mx-auto flex justify-between items-center px-2 py-3">
          ...
          {/* Desktop Navigation */}
          <ul className="hidden md:flex space-x-16  text-white font-roboto ">
            {[
              { path: "/", label: "Home" },
